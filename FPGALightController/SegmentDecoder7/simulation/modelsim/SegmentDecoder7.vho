...
-- Equation(s):
-- \HEX~0_combout\ = ( \SW[3]~input_o\ & ( (\SW[0]~input_o\ & (!\SW[2]~input_o\ $ (!\SW[1]~input_o\))) ) ) # ( !\SW[3]~input_o\ & ( (!\SW[1]~input_o\ & (!\SW[2]~input_o\ $ (!\SW[0]~input_o\))) ) )
...
-- Equation(s):
-- \HEX~1_combout\ = ( \SW[3]~input_o\ & ( (!\SW[0]~input_o\ & ((\SW[2]~input_o\))) # (\SW[0]~input_o\ & (\SW[1]~input_o\)) ) ) # ( !\SW[3]~input_o\ & ( (\SW[2]~input_o\ & (!\SW[1]~input_o\ $ (!\SW[0]~input_o\))) ) )
...
-- Equation(s):
-- \HEX~2_combout\ = ( \SW[2]~input_o\ & ( \SW[3]~input_o\ & ( (!\SW[0]~input_o\) # (\SW[1]~input_o\) ) ) ) # ( !\SW[2]~input_o\ & ( !\SW[3]~input_o\ & ( (!\SW[0]~input_o\ & \SW[1]~input_o\) ) ) )
...
-- Equation(s):
-- \HEX~3_combout\ = ( \SW[3]~input_o\ & ( (!\SW[2]~input_o\ & (!\SW[0]~input_o\ $ (\SW[1]~input_o\))) # (\SW[2]~input_o\ & ((!\SW[0]~input_o\) # (!\SW[1]~input_o\))) ) ) # ( !\SW[3]~input_o\ & ( (!\SW[2]~input_o\ & ((!\SW[0]~input_o\) # (\SW[1]~input_o\))) 
-- # (\SW[2]~input_o\ & (!\SW[0]~input_o\ $ (!\SW[1]~input_o\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1001111010011110100111101001111011010110110101101101011011010110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_SW[2]~input_o\,
...
-- Equation(s):
-- \HEX~4_combout\ = ( \SW[3]~input_o\ & ( (!\SW[2]~input_o\ & (\SW[0]~input_o\ & !\SW[1]~input_o\)) ) ) # ( !\SW[3]~input_o\ & ( ((\SW[2]~input_o\ & !\SW[1]~input_o\)) # (\SW[0]~input_o\) ) )
...
-- Equation(s):
-- \HEX~5_combout\ = ( \SW[3]~input_o\ & ( (!\SW[1]~input_o\ & (\SW[0]~input_o\ & \SW[2]~input_o\)) ) ) # ( !\SW[3]~input_o\ & ( (!\SW[1]~input_o\ & (\SW[0]~input_o\ & !\SW[2]~input_o\)) # (\SW[1]~input_o\ & ((!\SW[2]~input_o\) # (\SW[0]~input_o\))) ) )
...
-- Equation(s):
-- \HEX~6_combout\ = ( \SW[3]~input_o\ & ( (!\SW[1]~input_o\ & (!\SW[0]~input_o\ & \SW[2]~input_o\)) ) ) # ( !\SW[3]~input_o\ & ( (!\SW[1]~input_o\ & ((!\SW[2]~input_o\))) # (\SW[1]~input_o\ & (\SW[0]~input_o\ & \SW[2]~input_o\)) ) )
