...
vlog -vlog01compat -work work +incdir+. {TopLevel.vo}

vcom -93 -work work {C:/Users/colem/Documents/VHDL-Projects/FPGAAdvancedDesign/TopLevel.vhd}

vsim -t 1ps -L altera_ver -L altera_lnsim_ver -L cyclonev_ver -L lpm_ver -L sgate_ver -L cyclonev_hssi_ver -L altera_mf_ver -L cyclonev_pcie_hip_ver -L gate_work -L work -voptargs="+acc"  TopLevelTest
